...
public class TwoPlayerActivity extends AppCompatActivity {
   ...
   // MyClientSocket myClientSocket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ClientThread clientThread = new ClientThread( "192.168.1.112", 8888);
        clientThread.start();
    ...
    private class ClientThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                if(msgLog.equals("You're PLAYERA")){
                    player=0;
                } else player=1;
                ...
                while (!goOut) {
                    ...
                    if (dataInputStream.available() > 0) {
                        ...
                        if(status.equals("win")){
                            boardClient.onDrawBoard(row, col, imgView, p);

                            Toast.makeText(TwoPlayerActivity.this,"GAME OVER",Toast.LENGTH_SHORT).show();
                        ...
                        //
                       // Toast.makeText(TwoPlayerActivity.this,str[3],Toast.LENGTH_LONG).show();
